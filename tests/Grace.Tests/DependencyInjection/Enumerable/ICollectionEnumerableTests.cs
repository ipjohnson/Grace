...
{
    public class ICollectionEnumerableTests
    {
        [Fact]
        public void Locate_ICollection_Enumerable()
        {
            ...
            var enumerable = container.Locate<ICollection<IMultipleService>>();
        ...
        public class ImportICollectionClass
        {
            public ImportICollectionClass(ICollection<IMultipleService> list)
            {
                List = list;
            }

            public ICollection<IMultipleService> List { get; }
        }
        ...
        public void Import_IList_Enumerable()
        {
            ...
            var instance = container.Locate<ImportICollectionClass>();
