...
namespace Grace.DependencyInjection.Impl.DelegateFactory
{
		...
		BaseGenericDelegateExportStrategy
	{
		...
		{
			Helper newHelper = new Helper(context, consider,locateKey, argNames[0], argNames[1], argNames[2], argNames[3]);
		...
		public class Helper
		{
			...
			/// <returns></returns>
			public TReturn Activate(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4)
			{
