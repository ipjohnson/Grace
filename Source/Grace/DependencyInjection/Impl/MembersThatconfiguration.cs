...
namespace Grace.DependencyInjection.Impl
{
    ...
    {
        private readonly List<Func<MemberInfo, bool>> _filters = new List<Func<MemberInfo, bool>>();
        ...
        {
            return new GenericFilterGroup<MemberInfo>(configuration._filters.ToArray()) { UseOr = configuration._useOr };
        }
    }
}
