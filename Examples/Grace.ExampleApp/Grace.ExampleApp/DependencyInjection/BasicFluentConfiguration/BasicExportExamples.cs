...
namespace Grace.ExampleApp.DependencyInjection.FluentConfiguration
{
	...
	/// </summary>
	public class ExportByTypeExample : IExample<AdvancedFluentConfigurationModule>
	{
	...
	/// </summary>
	public class ExportWithNameExample : IExample<AdvancedFluentConfigurationModule>
	{
		public void ExecuteExample()
		{
			DependencyInjectionContainer container = new DependencyInjectionContainer();
	...
	/// </summary>
	public class RegisterWithKeyExample : IExample<AdvancedFluentConfigurationModule>
	{
		public void ExecuteExample()
		{
			DependencyInjectionContainer container = new DependencyInjectionContainer();
