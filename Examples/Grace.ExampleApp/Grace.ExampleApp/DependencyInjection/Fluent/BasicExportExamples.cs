...
namespace Grace.ExampleApp.DependencyInjection.Fluent
{
	...
	/// </summary>
	public class ExportByType : IExample<FluentSubModule>
	{
	...
	/// </summary>
	public class ExportWithName : IExample<FluentSubModule>
	{
		public void ExecuteExample()
		{
			DependencyInjectionContainer container = new DependencyInjectionContainer();
	...
	/// </summary>
	public class RegisterWithKey : IExample<FluentSubModule>
	{
		public void ExecuteExample()
		{
			DependencyInjectionContainer container = new DependencyInjectionContainer();
