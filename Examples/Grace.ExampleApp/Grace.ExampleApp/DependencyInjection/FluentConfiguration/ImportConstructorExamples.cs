...
namespace Grace.ExampleApp.DependencyInjection.FluentConfiguration
{
	...
	/// </summary>
	public class SimpleImportConstructorExample : IExample<FluentConfigurationSubModule>
	{
	...
	/// </summary>
	public class MixedParamerExample : IExample<FluentConfigurationSubModule>
	{
		public void ExecuteExample()
		{
			DependencyInjectionContainer container = new DependencyInjectionContainer();
	...
	/// </summary>
	public class LimitImportsByAttributesExample : IExample<FluentConfigurationSubModule>
	{
		public void ExecuteExample()
		{
			DependencyInjectionContainer container = new DependencyInjectionContainer();
